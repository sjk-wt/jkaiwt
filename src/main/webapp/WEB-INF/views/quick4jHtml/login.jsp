...
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/app/img/favicon.ico"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login" onkeydown="on_keyLoging()">
<!-- BEGIN LOGO -->
<div class="logo">
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form id="loginFrom" class="login-form" action="#" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="wt081001" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="remember" value="1" id="rmbUser"/> 记住我 </label>
			<button id="loginBut" type="button" class="btn blue pull-right" onclick="loginNest.saveUser()">
...
<script src="${pageContext.request.contextPath}/app/lib/security/sha256.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
    ...
    var loginAjax = {
        ...
        loginBut:function () {
            $("#loginBut").click(function () {
                ...
                var url = "${pageContext.request.contextPath}/rest/adminstrate/toLogin";
                $.post(url, data, function (result) {
                    if ("login" == result) {
                        alert("用户名或密码错误！");
                    } else {
                        location.href = "${pageContext.request.contextPath}/rest/adminstrate/home";
                    }
                });
            });
        }
    ...
    var loginNest = {
        ...
        saveUser:function(){
            if ($("#rmbUser").prop("checked") == true) {
                ...
                $.cookie("rmbUser", "true", { expires: 14 ,path: '/'}); // 存储一个带7天期限的 cookie
                $.cookie("userName", userName, { expires: 14 ,path: '/' }); // 存储一个带7天期限的 cookie
                $.cookie("passWord", passWord, { expires: 14 ,path: '/'  }); // 存储一个带7天期限的 cookie
            }
            else {
