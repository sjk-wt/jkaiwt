...
;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        e.length < 3 && (e = c.options.start.match(/\d+/g) || [], e.length < 3 && (e = [1980, d.getMonth() + 1, d.getDate()])), c.inymd = e, c.viewDate(e[0], e[1] - 1, e[2])
    }, c.iswrite = function () {
        ...
        c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"),
