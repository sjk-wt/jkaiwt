    ...
    jQuery(function () {
        $.fn.Tdrag = function (opt) {
            var call = {
                ...
                random: false,
                randomInput: null,
                animation_options: {duration: 800, easing: "ease-out"},
                disable: false,
                disableInput: null
            };
        ...
        Dragfn.prototype = {
            init: function (obj) {
                ...
                if (self.options.changeMode == "sort" && self.options.pos == true) {
                    ...
                    if (self.options.changeMode == "point" && self.options.pos == true) {
                        self.pointDrag(obj)
                    }
                }
                if (self.options.pos == true) {
                ...
                return {lmin: l1, tmin: t1, lmax: l2, tmax: t2}
                ...
                if (oNear) {
                    ...
                    if (self.options.changeWhen == "end") {
                        self.animation(obj, self.aPos[$(obj).attr("index")])
                    }
                }
