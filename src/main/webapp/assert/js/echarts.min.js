    ...
    return function (t) {
        ...
        var h = i(14), u = i(31), c = i(1), d = i(7), f = i(28), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                var n = i.getComponent("xAxis", e.get("xAxisIndex")), a = i.getComponent("yAxis", e.get("yAxisIndex")), o = n.get("type"), l = a.get("type"), h = [{
                    ...
                    type: s(o),
                    stackable: r(o)
                }, {name: "y", type: s(l), stackable: r(l)}], c = "category" === o;
                return u(h, t, ["x", "y", "z"]), {
                    dimensions: h,
                    categoryIndex: c ? 0 : 1,
                ...
                if (!L) {
                    ...
                    var H = function (t, e) {
                        ...
                        if (0 !== n)if (E = (e - I[i]) / n, v)if (V = T[i], O = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], b)u(O, V, N, B, E, E * E, E * E * E, d(t, a), A); else {
                            var l;
                            if (M)l = u(O, V, N, B, E, E * E, E * E * E, W, 1), l = f(W); else {
                                if (S)return r(V, N, E);
                            ...
                            var l;
                            if (M)s(T[i], T[i + 1], E, W, 1), l = f(W); else {
        ...
        a.extend(i(12).prototype, i(82)), t.exports = i(2).extendChartView({
            type: "bar", render: function (t, e, i) {
                ...
                e.eachItemGraphicEl(function (r, s) {
                    var l = e.getItemModel(s), h = e.getItemVisual(s, "color"), u = e.getItemLayout(s), c = l.getModel("itemStyle.normal"), d = l.getModel("itemStyle.emphasis").getBarItemStyle();
        ...
        var n = i(14), a = i(1), o = i(7), r = i(31), s = i(69), l = i(2).extendSeriesModel({
            type: "series.pie", init: function (t) {
                ...
                itemStyle: {
                    normal: {borderColor: "rgba(0,0,0,0)", borderWidth: 1}, emphasis: {
        ...
        var a = i(1), o = i(3), r = i(126), s = i(40), l = o.Rect, h = i(4), u = h.linearMap, c = i(11), d = i(71), f = h.asc, p = a.bind, g = Math.round, m = Math.max, v = a.each, y = 7, x = 1, _ = 30, w = "horizontal", b = "vertical", M = 5, S = ["line", "bar", "candlestick", "scatter"], A = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
                ...
                for (r = 0; r < t.length;) {
                    switch (a = t[r++], n = "", i = 0, a) {
                        ...
                        case d:
                            ...
                            r++;
                            var F = t[r++], W = R + y(N) * O, H = E + x(N) * V, M = R + y(B) * O, I = E + x(B) * V, Z = F ? " wa " : " at ";
        ...
        var a = i(1), o = i(15), r = i(2), s = i(7), l = i(347), h = i(73), u = h.mapVisual, c = h.eachVisual, d = i(4), f = a.isArray, p = a.each, g = d.asc, m = d.linearMap, v = r.extendComponentModel({
            type: "visualMap",
            dependencies: ["series"],
            dataBound: [-(1 / 0), 1 / 0],
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("candlestick", function (t) {
                ...
                n.each(a, function () {
                    ...
                    var s = arguments, l = a.length, h = s[0], u = s[l], c = "horizontal" === o ? 0 : 1, d = 1 - c, f = s[1], p = s[2], g = s[3], m = s[4], v = Math.min(f, p), y = Math.max(f, p), x = t(v), _ = t(y), w = t(g), b = t(m), M = [[b, _], [w, x]], S = [];
        ...
        var o = i(245), r = i(3), s = i(4), l = s.parsePercent, h = 2 * Math.PI, u = i(25).extend({
            ...
            _renderTicks: function (t, e, i, n, o, h, u, c) {
                for (var d = this.group, f = o.cx, p = o.cy, g = o.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), w = t.get("splitNumber"), b = x.get("splitNumber"), M = l(y.get("length"), g), S = l(x.get("length"), g), A = h, I = (u - h) / w, T = I / b, C = y.getModel("lineStyle").getLineStyle(), L = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; w >= P; P++) {
                    ...
                    if (_.get("show")) {
                        var E = a(s.round(P / w * (v - m) + m), _.get("formatter")), O = new r.Text({
                            style: {
                                text: E,
                                x: k * (g - M - 5) + f,
                                y: z * (g - M - 5) + p,
        ...
        t.exports = i(2).extendChartView({
            type: "radar", render: function (t, e, i) {
                ...
                d.diff(f).add(function (e) {
                    ...
                    var n = f.getItemGraphicEl(i), o = n.childAt(0), r = n.childAt(1), s = n.childAt(2), h = {
                        shape: {
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), o = e.getHeight(), r = t.option, s = r.size || [], l = _(w(r.width, s[0]), n), h = _(w(r.height, s[1]), o), u = y.getLayoutRect(t.getBoxLayoutParams(), {
                    width: e.getWidth(),
                    height: e.getHeight()
